[Tailscale 搭建derp中继节点，不需要域名，不需要备案，不需要申请证书（最新）](https://www.cnblogs.com/yafengabc/p/18591222 "发布于 2024-12-06 17:48")
----------------------------------------------------------------------------------------------------------------------------------------------------
...
apt search go-1.23 Sorting... Done
...
echo $PATH /usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/go-1.23/bin
...
DERP\_IP="12.12.12.12" openssl req \-x509 -newkey rsa:4096 -sha256 -days 3650 -nodes -keyout ${DERP\_IP}.key -out ${DERP\_IP}.crt -subj "/CN=${DERP\_IP}" -addext "subjectAltName=IP:${DERP\_IP}"
...
![](https://img2024.cnblogs.com/blog/760932/202412/760932-20241206174517753-26563037.png)
...
"derpMap": { //"OmitDefaultRegions": true,  //加入这个会只用自己的节点
    "Regions": { "901": { "RegionID":   901, "RegionCode": "song", "RegionName": "HW Cloud", "Nodes": \[
                { "Name":     "901a", "RegionID": 901,
                    "HostName":         "eksoft", //这个随便写 "IPv4":             "12.12.12.12", //改成自己的IP "InsecureForTests": true,
                },
            \],
        },
    },
...
![](https://img2024.cnblogs.com/blog/760932/202412/760932-20241206173922811-2102606864.png)

测试下延时，只有36ms。

![](https://img2024.cnblogs.com/blog/760932/202412/760932-20241206174748320-501559930.png)
